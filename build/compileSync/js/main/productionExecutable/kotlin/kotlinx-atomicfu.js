(function (factory) {
  ...
  protoOf(AtomicRef).li = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicRef).mi = function () {
  ...
  protoOf(AtomicBoolean).ni = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicBoolean).mi = function () {
    return this.kotlinx$atomicfu$value;
  };
  ...
  protoOf(AtomicInt).oi = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicInt).mi = function () {
    return this.kotlinx$atomicfu$value;
  };
