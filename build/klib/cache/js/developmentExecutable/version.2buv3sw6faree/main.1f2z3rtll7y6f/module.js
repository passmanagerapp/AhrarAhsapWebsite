(function (factory) {
  ...
  function HomePage($composer, $changed) {
    ...
    if (!($changed === 0) || !$composer_0.get_skipping_3owdve_k$()) {
      $composer_0.startReplaceGroup_5hh8aj_k$(-71263000);
      // Inline function 'androidx.compose.runtime.cache' call
      ...
      $composer_0.startReplaceGroup_5hh8aj_k$(-71260289);
      var tmp2 = $composer_0;
      // Inline function 'androidx.compose.runtime.cache' call
  ...
  function ComposableSingletons$IndexKt() {
    ...
    var tmp = this;
    tmp.lambda_1_r8sbbp_1 = ComposableLambda$invoke$ref_6(composableLambdaInstance(173261665, false, ComposableSingletons$IndexKt$lambda_1$lambda_5yb608));
  }
